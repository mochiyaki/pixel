...
def hello_gguf():
    ...
    parser.add_argument("--model_path", type=str, default="generator_model.safetensors",
...
if gguf_files:
    ...
    try:
        ...
        convert_gguf_to_safetensors(selected_file_path, "generator_model.safetensors", use_bf16=False)
        add_metadata_to_safetensors("generator_model.safetensors", {'image_size': '24', 'codings_size': '100', 'image_channels': '4'})
        hello_gguf()
